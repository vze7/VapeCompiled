...
do
	...
	getvapeasset = function(path)
		-- Core assets already have Roblox IDs. Avoid disk + HTTP on normal startup.
		-- Local files remain available for custom/unmapped assets or explicit developer override.
		if not shared.VapeUseLocalAssets and vapeAssets[path] then
			return vapeAssets[path]
		end
...
components = {
	...
	ChoiceList = function(props, children, api)
		local component = {
			Type = 'ChoiceList',
	...
	Label = function(props, children, api)
